...
x_0_cmssw = roc_2.xvalues
y_0_cmssw = roc_2.yvalues
# from IPython import embed;embed()

x_1_cmssw = roc_3.xvalues
y_1_cmssw = roc_3.yvalues
...
ax.plot(x_0, y_0, label="b vs udsg Retraining 2023", color="red")
ax.plot(x_0_cmssw, y_0_cmssw, label="b vs udsg CMSSW", color="blue")
ax.plot(x_1, y_1, label="b vs c Retraining", color="red", linestyle="dashed")
ax.plot(x_1_cmssw, y_1_cmssw, label="b vs c CMSSW", color="blue", linestyle="dashed")
...
fig, ax = plt.subplots(1, 1, figsize=(15, 10))
ax.plot(x_1, y_1, label="b vs c Retraining", color="red", linestyle="dashed")
ax.plot(x_0_cmssw, y_0_cmssw, label="b vs udsg CMSSW", color="red")
ax.set_title("RocCurve {}".format(label), fontsize=24)
ax.set_xlabel("b-id. efficiency")
ax.yaxis.set_ticks_position('both')
ax.xaxis.set_ticks_position('both')
