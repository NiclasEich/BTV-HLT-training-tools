...
python3 $BTVHLTToolsDirectory/DeepJetCore/bin/convertFromSource.py -i $OnlineTrainingFilesList -o $OnlineDirectory/djdc_files/${TrainingVersion}_deepCSV -c TrainData_DeepCSV_BatchNorm
