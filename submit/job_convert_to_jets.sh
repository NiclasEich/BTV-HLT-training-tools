...
out=/nfs/dust/cms/user/neich/BTV/nTuple-Producer/files/run3_220103_jet_shaped/test/
...
python3 -u $BTVHLTToolsDirectory/scripts/convert_events_to_jets.py -i $file -o $out --key qcd
